...
// $ Methods for ListeningHistoryData class.abstract

// ListeningHistoryData lhiFromMap(Map<dynamic, dynamic> lhiMap) {
...
// Map<dynamic, dynamic> lhiToMap(ListeningHistoryData lhi) {
//   return {
//     'id': lhi.id,
//     'url': lhi.url,
//     'name': lhi.name,
